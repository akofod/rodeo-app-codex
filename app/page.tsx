        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="max-w-3xl">
              <h1 className="mt-6 font-display text-3xl leading-tight text-slate-50 sm:text-4xl md:text-5xl lg:text-6xl">
                <span className="md:hidden">Find rodeos, jackpots.</span>
            ...
            <div className="relative mx-auto max-w-sm sm:max-w-md lg:mx-0 lg:max-w-none lg:pr-4">
              <Image
                src={heroImage}
                alt="Western Sports Hub hero"
                className="h-auto w-full rounded-3xl object-cover lg:scale-[0.92]"
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="rounded-3xl border border-white/25 bg-night-800/90 p-6 shadow-[0_14px_34px_rgba(0,0,0,0.45)]">
            ...
            >
              ...
              <button
                type="submit"
                className="inline-flex w-full items-center justify-center rounded-full border border-brand-400/50 bg-brand-400/20 px-6 py-3 text-sm font-semibold uppercase tracking-[0.2em] text-brand-100 transition hover:border-brand-300 hover:bg-brand-400/30 md:w-auto"
              >
                Search events
              </button>
            </form>
        ...
        <div className="relative mx-auto grid max-w-6xl gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex h-full flex-col rounded-3xl border border-white/25 bg-night-800/90 p-6 shadow-[0_14px_34px_rgba(0,0,0,0.45)]">
            ...
            <div className="mt-auto pt-6">
              <Link
                href="/map"
                className="inline-flex items-center rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-brand-100 transition hover:border-brand-300 hover:text-brand-50"
              >
                Open map
              </Link>
            </div>
