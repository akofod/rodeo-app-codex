  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[1fr_0.72fr]">
      <div className="rounded-2xl border border-white/10 bg-night-900/80 p-6">
        <h2 className="font-display text-2xl text-slate-100">Sign in</h2>
        <p className="mt-2 text-sm text-slate-300">
          Access saved favorites, submissions, and account tools.
        </p>
        {errorMessage ? (
        ...
        <AuthSignInForm action={signInWithEmail} />
      </div>
      <div className="rounded-2xl border border-white/10 bg-night-900/60 p-6">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-brand-300">New here?</p>
          <h3 className="mt-3 font-display text-xl text-slate-100">Create an account</h3>
          <p className="mt-2 text-sm text-slate-300">
            Create an account to submit listings and save favorites.
          </p>
        </div>
