    ...
    <section className="relative overflow-hidden px-6 py-8 sm:py-10">
      ...
      <div className="relative mx-auto flex w-full max-w-3xl flex-col gap-5">
        <div className="max-w-lg">
          ...
          <h1 className="mt-3 font-display text-3xl text-slate-100 sm:text-4xl">
        ...
        <div className="rounded-3xl border border-white/10 bg-night-800/80 p-5 shadow-glow sm:p-6">
          {children}
        </div>
      </div>
    </section>
